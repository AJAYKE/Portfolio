...
export default function Hero(): ReactElement {
  ...
  return (
    <div>
      <h1 className="sr-only">Hello I'm Ajay Edupuganti, I'm a curious software developer.</h1>
      <div className="relative z-10 flex h-[calc(100vh-81px)] items-center md:h-[calc(100vh-116px)]">
        <div className="mx-auto w-screen max-w-3xl px-4 sm:px-9 xl:max-w-5xl xl:px-0">
          <div className="-mt-36">
            <div ref={ref} className="flex cursor-default flex-col space-y-2">
              <h1 className="text-3xl font-semibold sm:text-5xl md:text-6xl xl:text-7xl">
                Ajay Edupuganti
              </h1>
              <h2 className="text-2.5xl font-medium opacity-80 sm:text-4xl md:text-4xl xl:text-5xl">
